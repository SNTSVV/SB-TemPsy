...
public class oscDetection4 {
	...
	public void test() throws ParserException {
		...
		.getClassLoader();
		String propertyFile = loader.getResource("oscillations/posc4.xmi") // here max amp=2 
				.getFile();
		String traceFile = loader.getResource("oscillations/osc4.csv")
				.getFile();
		SBTemPsyCheck checker=new SBTemPsyCheck(propertyFile, traceFile);
		
		assertFalse(checker.check());
	}
// not oscillations!! TBD
}
