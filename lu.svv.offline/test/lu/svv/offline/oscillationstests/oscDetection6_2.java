...
public class oscDetection6_2 {
	...
	public void test() throws ParserException {
		...
		.getClassLoader();
		String propertyFile = loader.getResource("oscillations/posc6_2.xmi") // here max amp=2 
				.getFile();
		String traceFile = loader.getResource("oscillations/osc6_2.csv")
				.getFile();
