...
public class oscDetection5 {
	...
	public void test() throws ParserException {
		...
		.getClassLoader();
		String propertyFile = loader.getResource("oscillations/posc5.xmi") // here max amp=2 
				.getFile();
		String traceFile = loader.getResource("oscillations/osc5.csv")
				.getFile();
