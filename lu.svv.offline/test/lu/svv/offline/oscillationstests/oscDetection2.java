...
public class oscDetection2 {
	...
	public void test() throws ParserException {
		...
		.getClassLoader();
		String propertyFile = loader.getResource("oscillations/posc2.xmi") // here max amp=2 
				.getFile();
		String traceFile = loader.getResource("oscillations/osc2.csv")
				.getFile();
