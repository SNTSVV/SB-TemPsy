...
public class amplitude1 {
	...
	public void test() throws ParserException {
		...
		.getClassLoader();
		String propertyFile = loader.getResource("spike/amplitude1.xmi") // here max amp=2 
				.getFile();
		String traceFile = loader.getResource("spike/amplitude1.csv")
				.getFile();
