...
public class amplitude2 {
	...
	public void test() throws ParserException {
		...
		.getClassLoader();
		String propertyFile = loader.getResource("spike/amplitude2.xmi") // here max amp=2 
				.getFile();
		String traceFile = loader.getResource("spike/amplitude2.csv")
				.getFile();
