...
public class amplitude3 {
	...
	public void test() throws ParserException {
		...
		.getClassLoader();
		String propertyFile = loader.getResource("spike/amplitude3.xmi") // here max amp=2 
				.getFile();
		String traceFile = loader.getResource("spike/amplitude3.csv")
				.getFile();
