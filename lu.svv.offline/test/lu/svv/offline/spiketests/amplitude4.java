...
public class amplitude4 {
	...
	public void test() throws ParserException {
		...
		.getClassLoader();
		String propertyFile = loader.getResource("spike/amplitude4.xmi") // here max amp=2 
				.getFile();
		String traceFile = loader.getResource("spike/amplitude4.csv")
				.getFile();
